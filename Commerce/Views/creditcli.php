...
<nav class="navbar navbar-inverse">
    ...
    <div class="container col-md-6 col-md-offset-3 marge">
		<div class="panel panel-info">
			<div class="panel-heading">DETTE CLIENT</div>
				<div class="panel-body">
					<table class="table table-bordered table-striped">
						<tr>
							<th class="text text-center">Client</th>
							<th class="text text-center">Dette</th>					
						</tr>
						<?php
							require_once '../Model/creditfdao.php';
							require_once '../Model/Clientdao.php';
							$result = listcreditcli();
							while( $tab = mysqli_fetch_row($result))
							{
								$client = getclientbyid($tab[0]);
								$row = mysqli_fetch_assoc($client);
								echo "<tr>";
									echo "<td class='text text-center'>$row[prenom] $row[nom] $row[telPart]</td>";
