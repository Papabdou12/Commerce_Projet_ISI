...
<nav class="navbar navbar-inverse">
    ...
    <div class="container col-md-6 col-md-offset-3 marge">
		<div class="panel panel-info">
			<div class="panel-heading">Formulaire de vente</div>
			<div class="panel-body">
				<form method="POST" action="../Controller/Tvente.php?">
		...
		if (isset($_GET['ok'])) 
		{
			...
			if ($ok == 0) 
			{
				echo "<ul class='text text-danger'>ERREUR: Commande non satisfaisable !!!</ul>";
			}
		}
	?>
					</div>
