			...
			<div class="panel-heading">LISTE DES FACTURES</div>
				<div class="panel-body">
					<table class="table table-bordered table-striped">
						<tr>
							<th class="text text-center">Num Facture</th>
							<th class="text text-center">Produit</th>
							<th class="text text-center">Prix</th>
							<th class="text text-center">Quantité</th>
							<th class="text text-center">Montant</th>
							<th class="text text-center">Réglement</th>
						...
						<?php
							...
							{
								$produit = getproduitbycode($tab[1]);
								$row = mysqli_fetch_assoc($produit);
								echo "<tr>";
									echo "<td class='text text-center'>$tab[0]</td>";
									echo "<td class='text text-center'>$row[designation]</td>";
									echo "<td class='text text-center'>$tab[2]</td>";
									echo "<td class='text text-center'>$tab[3]</td>";
									echo "<td class='text text-center'>$tab[4]</td>";
									echo "<td class='text text-center'>$tab[5]</td>";
								echo "</tr>";
							}
						?>
					</table>
