...
<nav class="navbar navbar-inverse">
    ...
    <div class="container col-md-6 col-md-offset-3 marge">
		<div class="panel panel-info">
			<div class="panel-heading">CREDIT FOURNISSEUR</div>
				<div class="panel-body">
					<table class="table table-bordered table-striped">
						<tr>
							<th class="text text-center">Fournisseur</th>
							<th class="text text-center">Montant du</th>					
						</tr>
						<?php
							...
							{
								$fournisseur = getfournisseurbyid($tab[0]);
								$row = mysqli_fetch_assoc($fournisseur);
								echo "<tr>";
									echo "<td class='text text-center'>$row[raisonS]</td>";
