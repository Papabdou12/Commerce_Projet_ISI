...
<nav class="navbar navbar-inverse">
    ...
    <div class="container col-md-6 col-md-offset-3 marge">
		<div class="panel panel-info">
			<div class="panel-heading">Formulaire d'ajout d'un fournisseur</div>
			<div class="panel-body">
				<form method="POST" action="../Controller/TAjoutF.php">
					<div class="form-group">
						<label>Raison sociale</label>
						<input type="text" name="raisonS" class="form-control" required="">
					</div>
					<div class="form-group">
						<label>Adresse</label>
						<input type="text" name="adrEnt" class="form-control" required="">
					</div>
					<div class="form-group">
						<label>Téléphone</label>
						<input type="number" name="telEnt" class="form-control" required="">
					</div>
					<div class="form-group">
