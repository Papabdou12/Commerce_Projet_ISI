...
<nav class="navbar navbar-inverse">
    ...
    <div class="container col-md-6 col-md-offset-3 marge">
		<div class="panel panel-info">
			<div class="panel-heading">Formulaire de modification de produit</div>
			<div class="panel-body">
				<form method="POST" action="../Controller/TModifProd.php">
					<div class="form-group">
						<label>code</label>
						<input type="number" name="code" readonly="" class="form-control" readonly=""
						value="<?= $tab[0] ?>">
					</div>
					<div class="form-group">
						<label>Désignation</label>
						<input type="text" name="designation" class="form-control" required="" value="<?= $tab[1] ?>">
					</div>
					<div class="form-group">
						<label>prix</label>
						<input type="number" name="prix" class="form-control" required="" value="<?= $tab[2] ?>">
					</div>
					<div class="form-group">
						<label>qtstock</label>
						<input type="number" name="qtstock" class="form-control" readonly="" value="<?= $tab[3] ?>">
					</div>
					<div class="form-group">
