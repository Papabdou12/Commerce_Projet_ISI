<?php
	...
	{
		$idEnt = $_GET['idEnt'];
		$result = getfournisseurbyid($idEnt);
...
<nav class="navbar navbar-inverse">
    ...
    <div class="container col-md-6 col-md-offset-3 marge">
		<div class="panel panel-info">
			<div class="panel-heading">Formulaire de modification de fournisseur</div>
			<div class="panel-body">
				<form method="POST" action="../Controller/TModifEnt.php">
					<div class="form-group">
						<label>ID Fournisseur</label>
						<input type="text" name="idEnt" readonly="" class="form-control" required="" value="<?= $tab[0] ?>">
					</div>
					<div class="form-group">
						<label>Raison Social</label>
						<input type="text" name="raisonS" class="form-control" required="" value="<?= $tab[1] ?>">
					</div>
					<div class="form-group">
						<label>Adresse </label>
						<input type="text" name="adrEnt" class="form-control" value="<?= $tab[2] ?>">
					</div>
					<div class="form-group">
						<label>Téléphone</label>
						<input type="number" name="adrEnt" class="form-control" value="<?= $tab[3] ?>">
					</div>
					<div class="form-group">
