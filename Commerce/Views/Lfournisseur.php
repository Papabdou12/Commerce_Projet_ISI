		...
		<div class="panel panel-info">
			<div class="panel-heading">LISTE DES FOURNISSEURS</div>
				<div class="panel-body">
					<a href="FAjoutF.php" class="btn btn-info">Ajouter fournisseur</a>
					<table class="table table-bordered table-striped">
						<tr>
							<th class="text text-center">ID fournisseur</th>
							<th class="text text-center">Raison Sociale</th>
						...
						<?php
							...
							{
								echo "<tr>";
									echo "<td class='text text-center'>$tab[idEnt]</td>";
									echo "<td class='text text-center'>$tab[raisonS]</td>";
									echo "<td class='text text-center'>$tab[adrEnt]</td>";
									echo "<td class='text text-center'>$tab[telEnt]</td>";
									echo "<td><a href='FModifF.php?idEnt=$tab[idEnt]' class='btn btn-info btn-block'>Modifier</a></td>";
									echo "<td><a href='../Controller/TSupF.php?idEnt=$tab[idEnt]' class='btn btn-warning btn-block'onClick='return confirmation();'>Supprimer</a></td>";
								echo "</tr>";
							}
						?>
					</table>
