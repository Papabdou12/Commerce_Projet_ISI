		...
		<div class="panel panel-info">
			<div class="panel-heading">LISTE DES PRODUITS</div>
				<div class="panel-body">
					<a href="FAjoutProd.php" class="btn btn-info">Nouveau produit</a>
					<table class="table table-bordered table-striped">
						<tr>
							<th class="text text-center">code</th>
							<th class="text text-center">Désignation</th>
							<th class="text text-center">Prix</th>
							<th class="text text-center">Quantité stock</th>
						...
						<?php
							...
							{
								echo "<tr>";
									echo "<td class='text text-center'>$tab[code]</td>";
									echo "<td class='text text-center'>$tab[designation]</td>";
									echo "<td class='text text-center'>$tab[prix]</td>";
									echo "<td class='text text-center'>$tab[qtstock]</td>";
									echo "<td><a href='FModifProd.php?code=$tab[code]' class='btn btn-info btn-block'>Modifier</a></td>";
									echo "<td><a href='../Controller/TSupProd.php?code=$tab[code]' class='btn btn-warning btn-block' onClick='return confirmation();'>Supprimer</a></td>";
								echo "</tr>";
							}
						?>
					</table>
