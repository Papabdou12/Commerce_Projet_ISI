...
function ajoute_client($nc,$r,$a,$v,$p,$t){
mysql_query("INSERT INTO client(numclient,raison_sociale,adresse_client,ville_client,pays,telephone) VALUES($nc,'$r','$a','$v','$p',$t);") or die(mysql_error());
...
ajoute_client($_POST['num_client'],$_POST['raison_sociale'],$_POST['adr_client'],$_POST['ville_client'],$_POST['pays'],$_POST['telephone']);
