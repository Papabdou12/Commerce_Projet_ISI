...
<nav class="navbar navbar-inverse">
    ...
    <div class="container col-md-6 col-md-offset-3 marge">
		<div class="panel panel-info">
			<div class="panel-heading">Formulaire d'ajout d'un client</div>
			<div class="panel-body">
				<form method="POST" action="../Controller/TAjoutCli.php">
					...
					<div class="form-group">
						<label>Adresse</label>
						<input type="text" name="adrPart" class="form-control" required="">
					</div>
					<div class="form-group">
						<label>Téléphone</label>
						<input type="number" name="telPart" class="form-control" required="">
					</div>
					<div class="form-group">
