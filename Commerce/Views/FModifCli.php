...
<nav class="navbar navbar-inverse">
 ...
 <div class="container col-md-6 col-md-offset-3 marge">
		<div class="panel panel-info">
			<div class="panel-heading">Formulaire de modification des infos d'un client</div>
			<div class="panel-body">
				<form method="POST" action="../Controller/TModifCli.php">
					<div class="form-group">
						<label>ID Client</label>
						<input type="number" name="idPart" readonly="" class="form-control" readonly="" value="<?= $tab[0] ?>">
					</div>
					<div class="form-group">
						<label>Prénom</label>
						<input type="text" name="prenom" class="form-control" required=""  readonly="" value="<?= $tab[1] ?>">
					</div>
					<div class="form-group">
						<label>Nom </label>
						<input type="text" name="nom" class="form-control"  required=""  readonly="" value="<?= $tab[2] ?>">
					</div>
					<div class="form-group">
						<label>Adresse</label>
						<input type="text" name="adrPart" class="form-control"  required="" value="<?= $tab[3] ?>">
					</div>
					<div class="form-group">
						<label>Téléphone</label>
						<input type="number" name="telPart" class="form-control"  required="" value="<?= $tab[4] ?>">
					</div>
					<div class="form-group">
